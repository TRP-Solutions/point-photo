...
var PointPhoto = (function(){
	...
	function create_warning(){
		return create_element('div','pointphoto-warning',PointPhoto.create_icon('warning'));
	}
	...
	function PointPhotoImage(container){
		...
		this.warn_required = function(force_warning){
			if(
				force_warning
				|| (
					typeof private.container.dataset.pointphotoRequired != 'undefined'
					&& private.container.dataset.pointphotoState != 'image'
				)
			){
